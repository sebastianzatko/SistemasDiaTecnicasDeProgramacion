...
namespace cDatos
{
    public class DALOrdenDeCompra
    {
        ...
        {
            string comando = "SELECT ORDENCOMPRA.ID_ORDENCOMPRA,PROVEDOR.ID_PROVEDOR,PROVEDOR.NOMBRE,ORDENCOMPRA.FECHA FROM ORDENCOMPRA,PROVEDOR WHERE ORDENCOMPRA.ID_PROVEDOR=PROVEDOR.ID_PROVEDOR AND TIPO='FALTANTE'";
            DataTable tabla=conexion.LeerPorComando(comando);
            return tabla;
        }
